...
def main(df, to_excel):
    ...
    计算正确率
    """
    f = open('数据/17 情感词典预测正确率.txt','w', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    # main(dfData, to_excel='数据/17 顾客需求分类2情感预测2.xlsx')

    # dfData = pd.read_excel('数据/17 顾客需求分类2情感预测3.xlsx',index_col=0)
    # main(dfData, to_excel='数据/17 顾客需求分类2情感预测4.xlsx')

    dfData = pd.read_excel('数据/17 顾客需求分类2情感预测3.2.xlsx',index_col=0)
    main(dfData, to_excel='数据/17 顾客需求分类2情感预测4.2.xlsx')
